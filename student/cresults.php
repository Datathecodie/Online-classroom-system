...
$validate1 = "SELECT * FROM course_details where c_id = '".$cid."'  ";
...
<?php echo "<center><pre class = \"tab \"><h1> Hello ".$x." Welcome to Course \" ".$v1." \". </h1> <h3> Description: ".$v2.". Duration of the course: ".$v3." Days. </h3> </pre> </center>" ; ?>
        ...
        <center> <button> <a href="showcourse.php?cid=<?php echo $cid;?>"> Click to go back. </a></button> </center> <br />
        <?php $perc =$cor/$tot*100;
            //
        if($perc <35 && $retest != -1)
        {
          echo " <center> <button> <a href=\"codeenroll.php?sid=".$stid."&cid=".$retest."\"> Click to Enroll for Retest. </a></button> </center> <br /> ";
        }
        ?>
       <center> <iframe src="result1.php?cor=<?php echo $cor;?>&tot=<?php echo $tot;?>" width="800" height="300"> </iframe> </center> 
        </section>
      </div>
