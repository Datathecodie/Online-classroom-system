...
$validate1 = "SELECT * FROM result where sid = '".$sid."' and cid = '".$cid."' and stid = '".$stid."' ";
...
<?php echo "<center><pre class = \"tab \"><h1> Hello ".$x." Welcome to Course \" ".$v1." \". </h1> <h3> Description: ".$v2.". Duration of the course: ".$v3." Days. <br> Session Number: ".$sid.". </h3> </pre> </center>" ; ?>

        <center> <button> <a href="showcourse.php?cid=<?php echo $cid;?>"> Click to go back. </a></button> </center>
       <center> <iframe src="result1.php?cor=<?php echo $cor;?>&tot=<?php echo $tot;?>" width="800" height="600"> </iframe> </center> 
        </section>
      </div>
