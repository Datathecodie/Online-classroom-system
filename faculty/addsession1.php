 ...
 <?php include("header.php"); ?>
  ...
  <div class="content-wrapper" width="95%">
    ...
    <section class="content">
        ...
        <br><br>
        <form class="form-horizontal" method="post" action="addsession2.php" enctype="multipart/form-data">
        <fieldset>
        ...
        <div class="form-group">
         ...
         <br>
            <div> 
                <label> Enter Number of Study materials to be uploaded for this session. </label> <br>
