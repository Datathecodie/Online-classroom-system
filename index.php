...
<body>
                        ...
                        <form class="form-horizontal" method="post" action="codelogin.php">
                            <div class="form-group " >
                                <div class="input-group">
                                    ...
                                    <input type="text" name="login_email" id="login_email" class="form-control" placeholder="Username or email" ="" value="">
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="input-group">
  ...
  <!--<link rel="stylesheet" href="http://localhost/otg.in/assets/login_css/bootstrap.min.css">
  <link rel="stylesheet" href="http://localhost/otg.in/assets/login_css/font-awesome.min.css">
  <script src="http://localhost/otg.in/assets/login_js/jquery.min.js"></script>
  <script src="http://localhost/otg.in/assets/login_js/bootstrap.min.js"></script>-->
