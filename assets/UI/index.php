...
<style>
.container{width:100%; margin-left:15px;margin-right:15px;}
</style>
</head>

<body>

<button class="ui button" tabindex="0">Follow</button>

<button class="ui primary button">
  Save
</button>
<button class="ui secondary button">Secondary Button Okay</button>
